...
class CreateChunkUploadCommandHandler(
    CommandHandler[picture_commands.CreateChunkUploadCommand, dict[str, Any]],
    BasePictureCommandHandler,
):
    def handle(
        self, command: picture_commands.CreateChunkUploadCommand
    ) -> dict[str, Any]:
...
class UploadChunkCommandHandler(
    CommandHandler[picture_commands.UploadChunkCommand, dict[str, Any]],
    BasePictureCommandHandler,
):
    def handle(self, command: picture_commands.UploadChunkCommand) -> dict[str, Any]:
...
class CompleteChunkUploadCommandHandler(
    CommandHandler[picture_commands.CompleteChunkUploadCommand, PictureDTO],
    BasePictureCommandHandler,
):
    def handle(
        self, command: picture_commands.CompleteChunkUploadCommand
    ) -> PictureDTO:
        if not self.chunk_upload_service:
            raise ApplicationError(_("Chunk upload service not available"))
