...
from picture.application.queries import GetPictureByIdQuery
from picture.infrastructure.forms import UpsertPictureForm
...
class UpdatePictureView(views.AdminGenericMixin, views.FormView):
    form_class = UpsertPictureForm
    template_name = "picture/picture_upsert.html"
    permission_required = ["picture_infrastructure.change_picture"]
    return_exc_response_as_json = True
...
class DeletePictureView(views.AdminGenericMixin, views.DeleteView):
    ...
    permission_required = ["picture_infrastructure.delete_picture"]
